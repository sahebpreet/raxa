...
Messages.raxa.view.Providers.itemTpl = '<div>{display} (10.34 Km)</div><div>★★★☆☆</div>';
Messages.raxa.view.Providers.emptyText =  'No Data to display';
Messages.raxa.view.Providers.title = "Doctors Near You";
